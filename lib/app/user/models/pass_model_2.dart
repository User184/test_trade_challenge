...
PassModel2 passModel2FromJson(String str) =>
    PassModel2.fromJson(json.decode(str));

String passModel2ToJson(PassModel2 data) => json.encode(data.toJson());
...
class PassModel2 {
  ...
  PassModel2.fromJson(dynamic json) {
