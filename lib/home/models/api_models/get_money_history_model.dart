...
GetMoneyHistory getMoneyHistoryFromJson(String str) =>
    GetMoneyHistory.fromJson(json.decode(str));
String getMoneyHistoryToJson(GetMoneyHistory data) =>
...
class Meta {
  ...
  Meta.fromJson(dynamic json) {
    ...
    availableMethods = json['available_methods'] != null
        ? AvailableMethods.fromJson(json['available_methods'])
        : null;
    if (json['cards'] != null) {
      cards = [];
...
AvailableMethods availableMethodsFromJson(String str) =>
    AvailableMethods.fromJson(json.decode(str));
String availableMethodsToJson(AvailableMethods data) =>
    json.encode(data.toJson());
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    map['status'] = status;
    map['title'] = title;
    map['has_acts'] = hasActs;
    map['act_status'] = actStatus;
    return map;
  }
}
